package com.example.quickbrew.Adapter
...
import com.example.quickbrew.Activity.ItemsListActivity


import com.example.quickbrew.Domain.CategoryModel
import com.example.quickbrew.databinding.ViewholderCategoryBinding
...
RecyclerView.Adapter<CategoryAdapter.Viewholder>(){
    ...
    override fun onBindViewHolder(holder: CategoryAdapter.Viewholder, position: Int) {
        ...
        if(selectedPosition==position){
           holder.binding.titleCat.setBackgroundResource(R.drawable.brown_full_corner_bd)
